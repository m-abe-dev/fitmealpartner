import { ExerciseTemplate, WorkoutDay, Exercise, LastRecordSet } from '../types/workout.types';
...
export const exerciseTemplates: ExerciseTemplate[] = [
  ...
  { id: "push-ups", name: "プッシュアップ", category: "Chest" },
...
export const categories = ["Chest", "Legs", "Shoulders", "Arms", "Back", "有酸素"];
